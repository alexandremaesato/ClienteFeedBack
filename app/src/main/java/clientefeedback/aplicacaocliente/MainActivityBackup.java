...
//                Toast.makeText(MainActivityBackup.this, "login", Toast.LENGTH_SHORT).show();
//                if (validateFields()) {
...
//        String url = Url.getUrl() + "autenticacao/login";
//
//        StringRequest jsonRequet = new AutorizacaoRequest(Request.Method.POST, url,
...
//        String url = Url.getUrl()+"autenticacao/cadastrar";
//
